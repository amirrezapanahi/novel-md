...
import * as HTMLConverter from 'node-html-markdown';
...
export const isWhiteSpaceOnly = (s) => !/\S/.test(s);
const options = {
    preferNativeParser: false,
    bulletMarker: '-',
};
export const htmlToMarkdown = (editorContent) => {
...
export const markdownToHtml = (markdownContent) => {
...
export const htmlToEditorState = (html) => {
    const json = generateJSON(html, [StarterKit, Link, Image, TaskItem, TaskList]);
    return json;
};
